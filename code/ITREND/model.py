...
class Model(nn.Module):
    ...
    def forward(self, s_node, t_node, s_self_feat, s_one_hop_feat,
                ...
                training=True):
        batch = s_node.size()[0]
        s_emb = self.gnn(s_self_feat, s_one_hop_feat,
                         e_time, s_his_time)  # [b,d]
        t_emb = self.gnn(t_self_feat, t_one_hop_feat,
                         e_time, t_his_time)  # [b,d]
        neg_embs = self.gnn(neg_self_feat, neg_one_hop_feat,
        ...
        L_model = log_event_intensity + neg_mean_intensity + l_theta
